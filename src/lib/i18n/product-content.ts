...
import {
  iphone14ProMaxIntroHe,
  iphone15IntroHe,
  iphone16IntroHe,
  iphone17IntroHe,
  iphone17ProIntroHe,
  iphone17ProMaxIntroHe,
  iphoneAirIntroHe,
  noteHe,
} from "./product-content-he-intros";

function hebrewContent(intro: string, en: ProductContent): ProductContent {
  return { intro, specs: en.specs, note: noteHe };
}
...
function getIphone14ProMaxContent(storage: string) {
  ...
  return {
    ...
    he: hebrewContent(iphone14ProMaxIntroHe, en),
  };
}
...
function getIphone15Content(storage: string) {
  ...
  return {
    ...
    he: hebrewContent(iphone15IntroHe, en),
  };
}
...
function getIphone16Content(storage: string) {
  ...
  return {
    ...
    he: hebrewContent(iphone16IntroHe, en),
  };
}
...
function getIphone17LineContent(line: Iphone17Line, storage?: string) {
  ...
  const config: Record<
    Iphone17Line,
    {
      ...
      display: string;
      intro: { en: string; ru: string; uk: string; he: string };
      chip: string;
    }
  > = {
    "17": {
